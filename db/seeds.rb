...
student_user2 = User.create(first_name: "student", last_name: "example2", role: "student2", email: "studentemail2@tamu.edu")
...
student2 = Student.create(student_id: student_user2.user_id, course_id: course3.course_id, gender: "Male", nationality: "American", work_auth: "US Citizen", contract_sign: "Ok with Any Agreements", uin: 123123124, resume: "Nodejs, Javascript, Java, Python")
ethnicity_value3 = EthnicityValue.create(student_id: student2.student_id, ethnicity_name: "White")
ethnicity_value4 = EthnicityValue.create(student_id: student2.student_id, ethnicity_name: "Black or African American")
...
scores_entity3 = ScoresEntity.create(student_id: student2.student_id, project_id: project.project_id, pref: 1)
scores_entity4 = ScoresEntity.create(student_id: student2.student_id, project_id: project01.project_id, pref: 2)
...
scores_value1 = ScoresValue.create(scores_id: scores_entity4.scores_id, attribute_id: attribute1.attribute_id, feature_score: 50)
scores_value2 = ScoresValue.create(scores_id: scores_entity4.scores_id, attribute_id: attribute2.attribute_id, feature_score: 100)
scores_value3 = ScoresValue.create(scores_id: scores_entity4.scores_id, attribute_id: attribute3.attribute_id, feature_score: 75)

scores_value1_2 = ScoresValue.create(scores_id: scores_entity3.scores_id, attribute_id: attribute1.attribute_id, feature_score: 100)
scores_value2_2 = ScoresValue.create(scores_id: scores_entity3.scores_id, attribute_id: attribute2.attribute_id, feature_score: 100)
scores_value3_2 = ScoresValue.create(scores_id: scores_entity3.scores_id, attribute_id: attribute3.attribute_id, feature_score: 100)
...
restriction2 = SponsorRestriction.create(restriction_type: "gender", restriction_val: "Female", project_id: project.project_id)
